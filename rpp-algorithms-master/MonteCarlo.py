...
df = pd.read_csv('ans2.csv')
df2 = pd.read_csv('parsed_sol.txt')
G1 = nx.Graph()
G2 = nx.Graph()
for index, rows in df.iterrows():
    G1.add_node(rows['node1'])
    G1.add_node(rows['node2'])
...
str1 = 'visited '+str(yes) +' no of nodes out of '+ str(yes + no) + '\n' +'This solution is: '+str(percent_accuracy)+' accurate'
print(str1)
print(did_not_visit)
